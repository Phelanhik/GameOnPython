...
class Galery():
    ...
    for n in range(14):
        path = 'sprites/'
        character_image_link = (path + 'Rumble/' + str(n+1) + '.png')
    ...
    for n in range(8):
        path = 'sprites/'
        character_image_link = (path + 'Rumble/' + str(n+29) + '.png')
        character_image = pygame.image.load(character_image_link)
        character_image = pygame.transform.scale(character_image, (250,300))
        galery.append(character_image)
    for n in range(8):
        ...
        galery.append(character_image)  
    character_image_link = (path + 'Rumble/' + str(45) + '.png')
    character_image = pygame.image.load(character_image_link)
    character_image = pygame.transform.scale(character_image, (250,300))
    galery.append(character_image)
    character_image = pygame.transform.flip(galery[44], True, False)
    galery.append(character_image)  
    for n in range(6):
        path = 'sprites/'
        character_image_link = (path + 'Rumble/' + str(n+47) + '.png')
        character_image = pygame.image.load(character_image_link)
        character_image = pygame.transform.scale(character_image, (250,300))
        galery.append(character_image)
    for n in range(6):
        character_image = pygame.transform.flip(galery[n+46], True, False)
        galery.append(character_image)
    for n in range(8):
        path = 'sprites/'
        character_image_link = (path + 'Rumble/' + str(n+53) + '.png')
        character_image = pygame.image.load(character_image_link)
        character_image = pygame.transform.scale(character_image, (250,300))
        galery.append(character_image)
    for n in range(8):
        character_image = pygame.transform.flip(galery[n+52], True, False)
        galery.append(character_image)    
    print(len(galery))
